...
fun GeometryFieldDialog(
  ...
  val center by viewModel.mapLocation.observeAsState()
            ...
            actions = {
              ...
              TextButton(
                onClick = {
                  ...
                  val location = ObservationLocation(geometry = Point(latLng.longitude, latLng.latitude))
...
//                id = R.drawable.ic_point_scan_outlined_24),
